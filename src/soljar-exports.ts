...
export function getSoljarProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...SoljarIDL, address: address ? address.toBase58() : SoljarIDL.address } as Soljar, provider)
}
